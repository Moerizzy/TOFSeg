...
weights_name = "unetformer_lsk_t"
weights_path = "model_weights/tif_tof/{}".format(weights_name)
test_weights_name = "unetformer_lsk_t"
...
train_dataset = TOFDataset(
    data_root="data/tif_tof/train",
    mode="test",
    transform=train_aug,
    #    mosaic_ratio=0.25,
)

val_dataset = TOFDataset(data_root="data/tif_tof/val", transform=val_aug, mode="test")
